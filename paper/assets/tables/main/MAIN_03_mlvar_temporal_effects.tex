\begin{table}[H]
\raggedright
\caption{Group-level temporal (lag-1) network: multilevel VAR fixed effects.}
\label{tab:temporal}
\footnotesize
\begingroup
...
\bottomrule
\end{tabular*}
\par\vspace{3pt}\noindent\parbox{\textwidth}{\footnotesize\textit{Note.} Standardized within-person coefficients. Cross-lagged effects are listed above autoregressive effects. Random SD = between-person standard deviation of the effect.}
\endgroup
\end{table}
